...
/**
 * PerformantHashMapEntry is a map entry (key-value pair) implementation of the Map.Entry interface. The PerformantHashMap.entrySet() method returns a collection-view of the map, whose elements are of this class. The only way to obtain a reference to a map entry is from the iterator of this collection-view.
 * @author Gaive Gandhi
 * @version 1.0
 */
